...
pub fn verifyAggregateSignature(messages: []const []const u8, signature: [BLS_SIGNATURE_SIZE]u8, public_keys: []const [BLS_PUBLIC_KEY_SIZE]u8) bool {
...
pub const ThresholdBLS = struct {
    ...
    pub fn generateShares(allocator: std.mem.Allocator, threshold: u32, total_shares: u32, master_key: [BLS_PRIVATE_KEY_SIZE]u8) ![]Share {
    ...
    pub fn combineSignatures(allocator: std.mem.Allocator, partial_sigs: []const struct { index: u32, signature: [BLS_SIGNATURE_SIZE]u8 }, threshold: u32) ![BLS_SIGNATURE_SIZE]u8 {
...
pub const bls = struct {
    ...
    pub fn verifyAggregate(messages: []const []const u8, signature: [BLS_SIGNATURE_SIZE]u8, public_keys: []const [BLS_PUBLIC_KEY_SIZE]u8) bool {
